  ...
  <body>
    <div class="container">
      ...
      @if ($errors->any())
        ...
        @endforeach
      @endif
      <h3><strong>Add Worker</strong></h3>
      Enter worker details below
      <hr />
      <form action="/coordinator/worker/add" method="post">
        {{ csrf_field() }}
        <div class="row">
      ...
      @endif
      <div class="btn-group">
        <button type="submit" action="save" class="btn btn-primary">Add Worker</button>
        <button type="submit" action="saveadd" class="btn btn-outline-primary">Add Next</button>
